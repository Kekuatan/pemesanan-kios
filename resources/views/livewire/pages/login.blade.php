                ...
                <div class="row auth-inner m-0">
                    ...
                    <div class="d-flex align-items-center auth-bg px-2 p-lg-5 col-lg-4">
                        <div class="px-xl-2 mx-auto col-sm-8 col-md-6 col-lg-12"><h2
                                class="card-title mb-1 font-weight-bold"> Selamat Datang 👋 </h2>
                            <p class="card-text mb-2"> Masukan username dan password anda. </p>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    role="group" class="input-group input-group-merge"><!----><input
                                                        ...
                                                        class="input-group-append"><div class="input-group-text">
<!--                                                            <svg-->
...
<!--                                            <div-->
                            ...
                            <div class="divider my-2">
                                <div class="divider-text"> pemesanan kios</div>
                            </div>
