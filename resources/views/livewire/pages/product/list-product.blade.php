                ...
                @foreach ($products as $product)
                    <tr role="row" class="bg-white font-small-2">
                        ...
                        <td aria-colindex="2" role="cell" class=""><span
                                class="text-nowrap">Fitbit - Activity Tracker</span></td>
                        <td aria-colindex="3" role="cell" class=""> Fitness</td>
                        <td aria-colindex="4" role="cell" class="">
                            <div class="progress" style="height: 7px;">
                                <div role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="50"
                                     class="progress-bar bg-success progress-bar-striped" style="width: 50%;"></div>
                            </div>
                        </td>
                        <td aria-colindex="5" role="cell" class=""><span
                                class="badge badge-success badge-pill"> Delivered </span></td>
                        <td aria-colindex="6" role="cell" class=""> $99.99</td>
                    </tr>
                @endforeach
                </tbody><!---->
            </table>
            ...
            <nav>
                <ul class="pagination">
                    ...
                    @foreach ($paginate['list_page'] as $list)
                        <li class="page-item {{$list['active'] ? 'active' : ''}} "><a class="page-link" href="{{ $list['link'] }}">{{ $list['label'] }}</a></li>
                    @endforeach
